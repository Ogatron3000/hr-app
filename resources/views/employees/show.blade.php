<x-app-layout>
    ...
    <div class="flex flex-col w-1/2 p-4 my-6 bg-white rounded-lg shadow-xs dark:bg-gray-800 dark:text-gray-400 shadow">
        ...
        <div class="mt-4">
            <div class="border-t p-2"><p class="text-xs font-semibold uppercase">Email</p> <p class="mt-1">{{ $employee->status()->joined }}</p></div>
            <div class="border-t p-2"><p class="text-xs font-semibold uppercase">Phone</p> <p class="mt-1">{{ $employee->status()->wage }}</p></div>
            <div class="border-t p-2"><p class="text-xs font-semibold uppercase">Office</p> <p class="mt-1">{{ $employee->status()->bank_account }}</p></div>
        </div>
    </div>
