<x-app-layout>
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        ...
        {{--<div--}}
        {{--    class="grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800"--}}
        {{-->--}}
