<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
    <div
        class="container flex items-start justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300"
    >
        <!-- Mobile hamburger -->
        <button
        ...
        <div>
            <form method="GET" action="{{ route('employees.index') }}">
                <div class="flex lg:mr-32">
                    ...
                    <button @click="toggleAdvancedSearch" type="button" class="mr-6">
